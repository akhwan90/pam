            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url'=>url('admin/pelanggan/addSave')]) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('alamat_dusun', '', ['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">RT</label>
                                    {!! Form::text('alamat_rt', '', ['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">RW</label>
                                    {!! Form::text('alamat_rw', '', ['class'=>'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('alamat_desa', '', ['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Kecamatan</label>
                                    {!! Form::text('alamat_kecamatan', '', ['class'=>'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
